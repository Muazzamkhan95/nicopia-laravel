                        ...
                        <div id="content_layout">
                            ...
                            <div class="card items-center p-3">
                                <div class="input-area">
                                    <h4 class="text-base text-slate-800 dark:text-slate-300 my-6">Service Form</h4>
                                </div>
                                <form action="{{ route('services.update', $service->id) }}" method="post"
                                    ...
                                    <div class="grid lg:grid-cols-1 md:grid-cols-1 grid-cols-1 gap-5">
                                        <div>
                                            ...
                                            <div class="input-area">
                                                <label for="description" class="form-label">kort beskrivning</label>
                                                <textarea name="description" class="form-control" id="description" cols="30" rows="5">{{ $service->description }}</textarea>
                                            </div>
                                            <div class="input-area">
                                                <label for="long_description" class="form-label">Lång Description</label>
                                                <textarea name="long_description" class="form-control" id="long_description" cols="30" rows="10">{{ $service->long_description }}</textarea>
                                            </div>
                                            <br>
                                                        ...
                                                        <label>
                                                            ...
                                                            <span
                                                                ...
                                                                <span
                                                                    ...
                                                                    <span id="placeholder" class="text-slate-400">Välj en fil eller släpp den här...</span>
                                                                </span>
                                                                <span name="image"
                                                    ...
                                                    <div class="filePreview">
                                                        <label>
                                                            ...
                                                            <span
                                                                ...
                                                                <span
                                                                    class="flex-1 overflow-hidden text-ellipsis whitespace-nowrap">
                                                                    <span id="placeholder" class="text-slate-400">Välj en andra bild...</span>
                                                                </span>
                                                                <span name="image1"
                                                                    class="file-name flex-none cursor-pointer border-l px-4 border-slate-200 dark:border-slate-700 h-full inline-flex items-center bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 text-sm rounded-tr rounded-br font-normal">Browse</span>
                                                            </span>
                                                        ...
                                                        <div id="file-preview">
                                                            <img width="width: 50px" src="{{ asset(''. $service->image1)}}" alt="image">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="text-end">
