                        ...
                        <div id="content_layout">
                            ...
                            <div class="card items-center p-3">
                                <div class="input-area">
                                    <h4 class="text-base text-slate-800 dark:text-slate-300 my-6">Tjänster Form</h4>
                                </div>
                                <form action="{{ route('services.store') }}" method="post"
                                    ...
                                    <div class="grid lg:grid-cols-2 md:grid-cols-1 grid-cols-1 gap-5">
                                        <div>
                                            <div class="input-area">
                                                <label for="name" class="form-label">Tjänster Title*</label>
                                            ...
                                            <div class="input-area">
                                                <label for="long_description" class="form-label">Lång beskrivning</label>
                                                <textarea name="long_description" class="form-control" id="long_description" cols="30" rows="10"></textarea>
                                            </div>
                                            <br>
                                            <div class="input-area">
