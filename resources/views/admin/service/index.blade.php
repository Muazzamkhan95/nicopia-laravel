                            ...
                            <div class="grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
                                @foreach ($services as $service)
                                    <div style="background: #000;"
                                        class="card rounded-md bg-dark dark:bg-slate-800 shadow-base custom-class card-body p-6">
                                        <header class="flex justify-between items-end">
                                            <div class="flex space-x-4 items-center rtl:space-x-reverse">
                                                <div class="font-medium text-base leading-6">
                                                    <div
                                                        class="text-white dark:text-slate-200 text-slate-900 max-w-[260px] truncate">
                                                        {{ $service->name }}
                                                    </div>
                                                </div>
                                            </div>
