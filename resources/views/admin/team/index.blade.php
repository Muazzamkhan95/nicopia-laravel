<x-base-layout>
                                ...
                                @foreach ($teams as $team)
                                    <div
                                        ...
                                        <div class="text-xs mt-3 mb-1 font-medium">
                                            <p>
                                                <b>Job Title</b>:{{ $team->job_description }}
                                            </p>
                                            <p>
                                                    ...
                                                    <div class="grid lg:grid-cols-1 md:grid-cols-1 grid-cols-1 gap-5">
                                                        <div>
                                                            <div class="input-area">
                                                                <label for="name" class="form-label">Member
                                                                    Name*</label>
    ...
    <script>
        $('a[data-bs-toggle="modal"]').on('click', function(event) {
            ...
            $.ajax({
                url: '{{ route('teams.edit', ['team' => ':id']) }}'.replace(':id', idval),
                method: 'GET',
                success: function(response) {
                    var editUrl = "{{ route('teams.update', 'team_id') }}";
                    editUrl = editUrl.replace('team_id', response.id);
