<x-base-layout>
                                            ...
                                            <div>
                                                <div class="dropstart relative">
                                                    ...
                                                    <ul
                                                        ...
                                                        <li>
                                                            <a href="" data-val="{{ $testimonial->id }}"
                                                    ...
                                                    <div class="grid lg:grid-cols-1 md:grid-cols-1 grid-cols-1 gap-5">
                                                        <div>
                                                            <div class="input-area">
                                                                <label for="name" class="form-label">Client
                                                                    Name*</label>
    ...
    <script>
        $('a[data-bs-toggle="modal"]').on('click', function(event) {
            ...
            $.ajax({
                url: '{{ route('testimonials.edit', ['testimonial' => ':id']) }}'.replace(':id', idval),
                method: 'GET',
                success: function(response) {
                    var editUrl = "{{ route('testimonials.update', 'testimonial_id') }}";
                    editUrl = editUrl.replace('testimonial_id', response.id);
