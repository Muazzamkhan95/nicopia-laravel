        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 d-flex">
                   ...
                   &nbsp; &nbsp; <a href="tel:+46155213900" class="text-white nav-link p-2"><i class="fa fa-phone"></i> +46 155 21 39 00</a>
                </div>
                <div class="col-md-5 d-flex justify-content-end">
                    <a href="#facebook" class="text-white nav-link p-2"><i class="fab fa-facebook"></i></a>
                    <a href="#facebook" class="text-white nav-link p-2"><i class="fab fa-instagram"></i></a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('home')}}#os-what-we-offer"><?php echo 'Tjänster
'; ?> </a>
                            </li>
                            <li class="nav-item">
